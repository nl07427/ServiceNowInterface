...
namespace ServiceNow.Graph.Requests
{
    ...
    /// </summary>
    public class UsersCollectionRequest : BaseRequest, IUsersCollectionRequest
    {
        /// <summary>
        /// New UsersCollectionRequest object
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public UsersCollectionRequest(string requestUrl, IBaseClient client, IEnumerable<Option> options = null) : base(requestUrl, client, options)
        {
        }
        ...
        public async Task<User> AddAsync(User entity, CancellationToken cancellationToken)
        {
            ...
            Method = "POST";
            var response = await SendAsync<UserResponse>(entity, cancellationToken).ConfigureAwait(false);
        ...
        public async Task<IUsersCollectionPage> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The collection page.</returns>
        public async Task<IUsersCollectionPage> GetAsync(CancellationToken cancellationToken)
        {
            Method = "GET";
            var response = await SendAsync<UsersCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        ...
        /// <returns>The request object to send.</returns>
        public IUsersCollectionRequest Skip(int value)
        {
        ...
        /// <returns></returns>
        public IUsersCollectionRequest OrderBy(string value)
        {
