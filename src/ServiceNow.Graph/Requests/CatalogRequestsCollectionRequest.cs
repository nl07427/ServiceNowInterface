...
{
    /// <summary>
    /// CatalogRequestsCollectionRequest
    /// </summary>
    public class CatalogRequestsCollectionRequest : BaseRequest, ICatalogRequestsCollectionRequest
    {
        /// <summary>
        ...
        public CatalogRequestsCollectionRequest(string requestUrl, IBaseClient client,
        ...
        public async Task<CatalogRequest> AddAsync(CatalogRequest entity)
        {
            ...
            CancellationToken cancellationToken)
        {
            ...
            Method = "POST";
            var response = await SendAsync<CatalogRequestResponse>(entity, cancellationToken)
        ...
        public async Task<ICatalogRequestsCollectionPage> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The collection page.</returns>
        public async Task<ICatalogRequestsCollectionPage> GetAsync(CancellationToken cancellationToken)
        {
            Method = "GET";
            var response = await SendAsync<CatalogRequestsCollectionResponse>(null, cancellationToken)
                .ConfigureAwait(false);
        ...
        /// <returns>The request object to send.</returns>
        public ICatalogRequestsCollectionRequest Top(int value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ICatalogRequestsCollectionRequest Skip(int value)
        {
        ...
        /// <returns></returns>
        public ICatalogRequestsCollectionRequest OrderBy(string value)
        {
