...
{
    /// <summary>
    /// ConfigurationItemsCollectionRequest
    /// </summary>
    public class ConfigurationItemsCollectionRequest : BaseRequest, IConfigurationItemsCollectionRequest
    {
        /// <summary>
        ...
        public ConfigurationItemsCollectionRequest(string requestUrl, IBaseClient client,
        ...
        public async Task<ConfigurationItem> AddAsync(ConfigurationItem entity)
        {
            ...
            CancellationToken cancellationToken)
        {
            ...
            Method = "POST";
            var response = await SendAsync<ConfigurationItemResponse>(entity, cancellationToken)
        ...
        public async Task<IConfigurationItemsCollectionPage> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The collection page.</returns>
        public async Task<IConfigurationItemsCollectionPage> GetAsync(CancellationToken cancellationToken)
        {
            Method = "GET";
            var response = await SendAsync<ConfigurationItemsCollectionResponse>(null, cancellationToken)
                .ConfigureAwait(false);
        ...
        public IConfigurationItemsCollectionRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IConfigurationItemsCollectionRequest Top(int value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IConfigurationItemsCollectionRequest Filter(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IConfigurationItemsCollectionRequest Skip(int value)
        {
        ...
        /// <returns></returns>
        public IConfigurationItemsCollectionRequest OrderBy(string value)
        {
