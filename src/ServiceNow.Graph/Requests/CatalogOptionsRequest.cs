...
namespace ServiceNow.Graph.Requests
{
    ...
    /// </summary>
    public class CatalogOptionsRequest : BaseRequest, ICatalogOptionsRequest
    {
        /// <summary>
        /// Constructs a new CatalogOptionsRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public CatalogOptionsRequest(
            string requestUrl,
            IBaseClient client,
        ...
        public async System.Threading.Tasks.Task<CatalogOptions> GetAsync(CancellationToken cancellationToken)
        {
            Method = "GET";
            var retrievedEntity =
                await SendAsync<CatalogOptionsResponse>(null, cancellationToken).ConfigureAwait(false);
            ...
            CancellationToken cancellationToken)
        {
            ...
            Method = "PATCH";
            var updatedEntity =
                await SendAsync<CatalogOptionsResponse>(toUpdate, cancellationToken).ConfigureAwait(false);
        ...
        public ICatalogOptionsRequest Select(string value)
        {
