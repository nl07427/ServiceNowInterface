...
{
    public class BuildingCollectionRequest : BaseRequest, IBuildingCollectionRequest
    {
        /// <summary>
        ...
        public BuildingCollectionRequest(string requestUrl, IBaseClient client,
            ...
            CancellationToken cancellationToken)
        {
            ...
            Method = "POST";
            var response = await SendAsync<BuildingResponse>(entity, cancellationToken)
        ...
        public async Task<IBuildingCollectionPage> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The collection page.</returns>
        public async Task<IBuildingCollectionPage> GetAsync(CancellationToken cancellationToken)
        {
            Method = "GET";
            var response = await SendAsync<BuildingCollectionResponse>(null, cancellationToken)
                .ConfigureAwait(false);
        ...
        /// <returns>The request object to send.</returns>
        public IBuildingCollectionRequest Top(int value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IBuildingCollectionRequest Skip(int value)
        {
        ...
        /// <returns></returns>
        public IBuildingCollectionRequest OrderBy(string value)
        {
