...
{
    /// <summary>
    /// RequestItemsCollectionRequest
    /// </summary>
    public class RequestItemsCollectionRequest : BaseRequest, IRequestItemsCollectionRequest
    {
        /// <summary>
        ...
        public RequestItemsCollectionRequest(string requestUrl, IBaseClient client,
        ...
        public async Task<RequestItem> AddAsync(RequestItem entity)
        {
            ...
            CancellationToken cancellationToken)
        {
            ...
            Method = "POST";
            var response = await SendAsync<RequestItemResponse>(entity, cancellationToken)
        ...
        public async Task<IRequestItemsCollectionPage> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The collection page.</returns>
        public async Task<IRequestItemsCollectionPage> GetAsync(CancellationToken cancellationToken)
        {
            Method = "GET";
            var response = await SendAsync<RequestItemsCollectionResponse>(null, cancellationToken)
                .ConfigureAwait(false);
        ...
        public IRequestItemsCollectionRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IRequestItemsCollectionRequest Top(int value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IRequestItemsCollectionRequest Filter(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IRequestItemsCollectionRequest Skip(int value)
        {
        ...
        /// <returns></returns>
        public IRequestItemsCollectionRequest OrderBy(string value)
        {
