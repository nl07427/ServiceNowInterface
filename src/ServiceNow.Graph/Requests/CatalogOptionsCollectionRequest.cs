...
{
    /// <summary>
    /// CatalogOptionsCollectionRequest
    /// </summary>
    public class CatalogOptionsCollectionRequest : BaseRequest, ICatalogOptionsCollectionRequest
    {
        /// <summary>
        ...
        public CatalogOptionsCollectionRequest(string requestUrl, IBaseClient client,
        ...
        public async Task<CatalogOptions> AddAsync(CatalogOptions entity)
        {
            ...
            CancellationToken cancellationToken)
        {
            ...
            Method = "POST";
            var response = await SendAsync<CatalogOptionsResponse>(entity, cancellationToken)
        ...
        public async Task<ICatalogOptionsCollectionPage> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The collection page.</returns>
        public async Task<ICatalogOptionsCollectionPage> GetAsync(CancellationToken cancellationToken)
        {
            Method = "GET";
            var response = await SendAsync<CatalogOptionsCollectionResponse>(null, cancellationToken)
                .ConfigureAwait(false);
        ...
        public ICatalogOptionsCollectionRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ICatalogOptionsCollectionRequest Top(int value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ICatalogOptionsCollectionRequest Filter(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ICatalogOptionsCollectionRequest Skip(int value)
        {
        ...
        /// <returns></returns>
        public ICatalogOptionsCollectionRequest OrderBy(string value)
        {
