...
{
    /// <summary>
    /// OrderGuidesCollectionRequest
    /// </summary>
    public class OrderGuidesCollectionRequest : BaseRequest, IOrderGuidesCollectionRequest
    {
        /// <summary>
        ...
        public OrderGuidesCollectionRequest(string requestUrl, IBaseClient client,
        ...
        public async Task<OrderGuide> AddAsync(OrderGuide entity)
        {
            ...
            CancellationToken cancellationToken)
        {
            ...
            Method = "POST";
            var response = await SendAsync<OrderGuideResponse>(entity, cancellationToken)
        ...
        public async Task<IOrderGuidesCollectionPage> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The collection page.</returns>
        public async Task<IOrderGuidesCollectionPage> GetAsync(CancellationToken cancellationToken)
        {
            Method = "GET";
            var response = await SendAsync<OrderGuidesCollectionResponse>(null, cancellationToken)
                .ConfigureAwait(false);
        ...
        public IOrderGuidesCollectionRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IOrderGuidesCollectionRequest Top(int value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IOrderGuidesCollectionRequest Filter(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IOrderGuidesCollectionRequest Skip(int value)
        {
        ...
        /// <returns></returns>
        public IOrderGuidesCollectionRequest OrderBy(string value)
        {
