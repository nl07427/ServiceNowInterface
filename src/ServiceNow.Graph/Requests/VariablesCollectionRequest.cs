...
{
    /// <summary>
    /// VariablesCollectionRequest
    /// </summary>
    public class VariablesCollectionRequest : BaseRequest, IVariablesCollectionRequest
    {
        /// <summary>
        ...
        public VariablesCollectionRequest(string requestUrl, IBaseClient client,
            ...
            CancellationToken cancellationToken)
        {
            ...
            Method = "POST";
            var response = await SendAsync<VariableResponse>(entity, cancellationToken)
        ...
        public async Task<IVariablesCollectionPage> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The collection page.</returns>
        public async Task<IVariablesCollectionPage> GetAsync(CancellationToken cancellationToken)
        {
            Method = "GET";
            var response = await SendAsync<VariablesCollectionResponse>(null, cancellationToken)
                .ConfigureAwait(false);
        ...
        public IVariablesCollectionRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IVariablesCollectionRequest Top(int value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IVariablesCollectionRequest Filter(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IVariablesCollectionRequest Skip(int value)
        {
        ...
        /// <returns></returns>
        public IVariablesCollectionRequest OrderBy(string value)
        {
