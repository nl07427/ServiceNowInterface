                ...
                throw new ClientException(
                    new Error
                    {
                        ErrorDetail = new ErrorDetail
                        {
                            ...
                            DetailedMessage = "Parameter name must not be null or an empty string."
                        }
                    });
            }
            ...
            if (value == null && !nullable)
            {
                throw new ServiceException(
                    new Error
                    {
                        ...
                        {
                            Message = "invalidRequest",
                            DetailedMessage = string.Format("{0} is a required parameter for this method request.", name),
                        }
                    });
            }
