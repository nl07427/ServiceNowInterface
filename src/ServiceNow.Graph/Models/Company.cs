...
namespace ServiceNow.Graph.Models
{
    ...
    public partial class Company : Entity
    {
        ...
        /// <summary>
        /// Agreement number, X40
        /// </summary>
        [JsonProperty(PropertyName = "u_agreement_number", NullValueHandling = NullValueHandling.Ignore, Required = Required.Default)]
        public string UAgreementNumber { get; set; }
