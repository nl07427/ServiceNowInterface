...
namespace ServiceNow.Graph.Requests
{
    ...
    /// TaskRequest
    /// </summary>
    public class TaskRequest : BaseRequest, ITaskRequest
    {
        /// <summary>
        ...
        public System.Threading.Tasks.Task<Task> CreateAsync(Task entry)
        {
        ...
        /// <returns>The created entity.</returns>
        public async System.Threading.Tasks.Task<Task> CreateAsync(Task entry,
            CancellationToken cancellationToken)
        {
            ContentType = "application/json";
            Method = "POST";
            var newEntity = await SendAsync<Task>(entry, cancellationToken).ConfigureAwait(false);
        ...
        {
            Method = "DELETE";
            await SendAsync<Task>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The entity (task table).</returns>
        public async System.Threading.Tasks.Task<Task> GetAsync(CancellationToken cancellationToken)
        {
            Method = "GET";
            var retrievedEntity =
                await SendAsync<TaskResponse>(null, cancellationToken).ConfigureAwait(false);
        ...
        public System.Threading.Tasks.Task<Task> UpdateAsync(Task toUpdate)
        {
        ...
        /// <returns>The updated entity.</returns>
        public async System.Threading.Tasks.Task<Task> UpdateAsync(Task toUpdate,
            CancellationToken cancellationToken)
        {
            ContentType = "application/json";
            Method = "PATCH";
            var updatedEntity =
                await SendAsync<TaskResponse>(toUpdate, cancellationToken).ConfigureAwait(false);
        ...
        /// </summary>
        /// <param name="toUpdate">The <see cref="Task"/> with the collection properties to initialize.</param>
        private void InitializeCollectionProperties(Task toUpdate)
        {
        }
    }
}
