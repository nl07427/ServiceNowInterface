...
{
    /// <summary>
    /// CompaniesCollectionRequest
    /// </summary>
    public class CompaniesCollectionRequest : BaseRequest, ICompaniesCollectionRequest
    {
        /// <summary>
        ...
        public CompaniesCollectionRequest(string requestUrl, IBaseClient client,
            ...
            CancellationToken cancellationToken)
        {
            ...
            Method = "POST";
            var response = await SendAsync<CompanyResponse>(entity, cancellationToken)
        ...
        public async Task<ICompaniesCollectionPage> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The collection page.</returns>
        public async Task<ICompaniesCollectionPage> GetAsync(CancellationToken cancellationToken)
        {
            Method = "GET";
            var response = await SendAsync<CompaniesCollectionResponse>(null, cancellationToken)
                .ConfigureAwait(false);
        ...
        public ICompaniesCollectionRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ICompaniesCollectionRequest Top(int value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ICompaniesCollectionRequest Filter(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ICompaniesCollectionRequest Skip(int value)
        {
        ...
        /// <returns></returns>
        public ICompaniesCollectionRequest OrderBy(string value)
        {
