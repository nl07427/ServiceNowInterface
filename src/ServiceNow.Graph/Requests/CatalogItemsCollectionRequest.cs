...
{
    /// <summary>
    /// CatalogItemsCollectionRequest
    /// </summary>
    public class CatalogItemsCollectionRequest : BaseRequest, ICatalogItemsCollectionRequest
    {
        /// <summary>
        ...
        public CatalogItemsCollectionRequest(string requestUrl, IBaseClient client,
            ...
            CancellationToken cancellationToken)
        {
            ...
            Method = "POST";
            var response = await SendAsync<CatalogItemResponse>(entity, cancellationToken)
        ...
        public async Task<ICatalogItemsCollectionPage> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The collection page.</returns>
        public async Task<ICatalogItemsCollectionPage> GetAsync(CancellationToken cancellationToken)
        {
            Method = "GET";
            var response = await SendAsync<CatalogItemsCollectionResponse>(null, cancellationToken)
                .ConfigureAwait(false);
        ...
        public ICatalogItemsCollectionRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ICatalogItemsCollectionRequest Top(int value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ICatalogItemsCollectionRequest Filter(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ICatalogItemsCollectionRequest Skip(int value)
        {
        ...
        /// <returns></returns>
        public ICatalogItemsCollectionRequest OrderBy(string value)
        {
