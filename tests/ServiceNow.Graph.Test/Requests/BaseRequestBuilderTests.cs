...
namespace ServiceNow.Graph.Test.Requests
{
    ...
    {
        const string requestUrl = "https://localhost:443/servicenow.graph.composablefunction0";
        ...
        public void ComposableFunctionTest()
        {
            ...
            var expected = @"https://localhost:443/servicenow.graph.composablefunction0(address='A1:B1')/servicenow.graph.composablefunction1(anotherValue='test-value')";
            var expectedFullUrl = "https://localhost/servicenow.graph.composablefunction0(address='A1:B1')/servicenow.graph.composablefunction1(anotherValue='test-value')?filter=name&orderby=date";
        ...
        public void ComposableFunctionTestWithSecondParameter()
        {
            ...
            var expected = @"https://localhost:443/servicenow.graph.composablefunction0(address='A1:B1')/servicenow.graph.composablefunction1(anotherValue='test-value',secondValue='test-value2')";
        ...
        public void ComposableFunctionWithNullParamTest()
        {
            ...
            var expected = @"https://localhost:443/servicenow.graph.composablefunction0(address=null)/servicenow.graph.composablefunction1(anotherValue='test-value')";
        ...
        public void ComposableFunctionWithNoParamsTest()
        {
            ...
            var expected = @"https://localhost:443/servicenow.graph.composablefunction0()/servicenow.graph.composablefunction1(anotherValue='test-value')";
