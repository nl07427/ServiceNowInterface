...
{
    /// <summary>
    /// IncidentsCollectionRequest
    /// </summary>
    public class IncidentsCollectionRequest : BaseRequest, IIncidentsCollectionRequest
    {
        /// <summary>
        ...
        public IncidentsCollectionRequest(string requestUrl, IBaseClient client,
            ...
            CancellationToken cancellationToken)
        {
            ...
            Method = "POST";
            var response = await SendAsync<IncidentResponse>(entity, cancellationToken)
        ...
        public async Task<IIncidentsCollectionPage> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The collection page.</returns>
        public async Task<IIncidentsCollectionPage> GetAsync(CancellationToken cancellationToken)
        {
            Method = "GET";
            var response = await SendAsync<IncidentsCollectionResponse>(null, cancellationToken)
                .ConfigureAwait(false);
        ...
        public IIncidentsCollectionRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IIncidentsCollectionRequest Top(int value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IIncidentsCollectionRequest Filter(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IIncidentsCollectionRequest Skip(int value)
        {
        ...
        /// <returns></returns>
        public IIncidentsCollectionRequest OrderBy(string value)
        {
