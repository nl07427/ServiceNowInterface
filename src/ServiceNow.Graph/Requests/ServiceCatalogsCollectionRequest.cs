...
{
    /// <summary>
    /// ServiceCatalogsCollectionRequest
    /// </summary>
    public class ServiceCatalogsCollectionRequest : BaseRequest, IServiceCatalogsCollectionRequest
    {
        /// <summary>
        ...
        public ServiceCatalogsCollectionRequest(string requestUrl, IBaseClient client,
        ...
        public async Task<ServiceCatalog> AddAsync(ServiceCatalog entity)
        {
            ...
            CancellationToken cancellationToken)
        {
            ...
            Method = "POST";
            var response = await SendAsync<ServiceCatalogResponse>(entity, cancellationToken)
        ...
        public async Task<IServiceCatalogsCollectionPage> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The collection page.</returns>
        public async Task<IServiceCatalogsCollectionPage> GetAsync(CancellationToken cancellationToken)
        {
            Method = "GET";
            var response = await SendAsync<ServiceCatalogsCollectionResponse>(null, cancellationToken)
                .ConfigureAwait(false);
        ...
        public IServiceCatalogsCollectionRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IServiceCatalogsCollectionRequest Top(int value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IServiceCatalogsCollectionRequest Filter(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IServiceCatalogsCollectionRequest Skip(int value)
        {
        ...
        /// <returns></returns>
        public IServiceCatalogsCollectionRequest OrderBy(string value)
        {
