namespace ServiceNow.Graph.Exceptions
{
    internal static class ErrorConstants
    {
        ...
        internal static class Messages
        {
            ...
            internal static string DomainMissing = "Domain cannot be null or empty.";

            internal static string VersionMissing = "API version cannot be null or empty.";

            internal static string InvalidTypeForDateConverter = "DateConverter can only serialize objects of type Date.";

            internal static string InvalidTypeForReferenceLinkConverter = "ReferenceLinkConverter can only serialize objects of type ReferenceLink.";
