...
namespace ServiceNow.Graph.Requests
{
    ...
    public class CompanyRequest : BaseRequest, ICompanyRequest
    {
        ...
        public System.Threading.Tasks.Task<Company> CreateAsync(Company entry)
        {
        ...
        /// <returns>The created entity.</returns>
        public async System.Threading.Tasks.Task<Company> CreateAsync(Company entry,
            CancellationToken cancellationToken)
        {
            ContentType = "application/json";
            Method = "POST";
            var newEntity = await SendAsync<Company>(entry, cancellationToken).ConfigureAwait(false);
        ...
        {
            Method = "DELETE";
            await SendAsync<Company>(null, cancellationToken).ConfigureAwait(false);
        }
        ...
        public async System.Threading.Tasks.Task<Company> GetAsync(CancellationToken cancellationToken)
        {
            Method = "GET";
            var retrievedEntity =
                await SendAsync<CompanyResponse>(null, cancellationToken).ConfigureAwait(false);
        ...
        public System.Threading.Tasks.Task<Company> UpdateAsync(Company toUpdate)
        {
        ...
        /// <returns>The updated entity.</returns>
        public async System.Threading.Tasks.Task<Company> UpdateAsync(Company toUpdate,
            CancellationToken cancellationToken)
        {
            ContentType = "application/json";
            Method = "PATCH";
            var updatedEntity =
                await SendAsync<CompanyResponse>(toUpdate, cancellationToken).ConfigureAwait(false);
        ...
        /// </summary>
        /// <param name="toUpdate">The <see cref="Company"/> with the collection properties to initialize.</param>
        private void InitializeCollectionProperties(Company toUpdate)
        {
        }
    }
}
