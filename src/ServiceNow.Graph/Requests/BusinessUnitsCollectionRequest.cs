...
{
    public class BusinessUnitsCollectionRequest : BaseRequest, IBusinessUnitsCollectionRequest
    {
        /// <summary>
        ...
        public BusinessUnitsCollectionRequest(string requestUrl, IBaseClient client,
        ...
        public async Task<BusinessUnit> AddAsync(BusinessUnit entity)
        {
            ...
            CancellationToken cancellationToken)
        {
            ...
            Method = "POST";
            var response = await SendAsync<BusinessUnitResponse>(entity, cancellationToken)
        ...
        public async Task<IBusinessUnitsCollectionPage> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The collection page.</returns>
        public async Task<IBusinessUnitsCollectionPage> GetAsync(CancellationToken cancellationToken)
        {
            Method = "GET";
            var response = await SendAsync<BusinessUnitsCollectionResponse>(null, cancellationToken)
                .ConfigureAwait(false);
        ...
        public IBusinessUnitsCollectionRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IBusinessUnitsCollectionRequest Top(int value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IBusinessUnitsCollectionRequest Filter(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IBusinessUnitsCollectionRequest Skip(int value)
        {
        ...
        /// <returns></returns>
        public IBusinessUnitsCollectionRequest OrderBy(string value)
        {
