...
{
    /// <summary>
    /// QuestionsCollectionRequest
    /// </summary>
    public class QuestionsCollectionRequest : BaseRequest, IQuestionsCollectionRequest
    {
        /// <summary>
        ...
        public QuestionsCollectionRequest(string requestUrl, IBaseClient client,
            ...
            CancellationToken cancellationToken)
        {
            ...
            Method = "POST";
            var response = await SendAsync<QuestionResponse>(entity, cancellationToken)
        ...
        public async Task<IQuestionsCollectionPage> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The collection page.</returns>
        public async Task<IQuestionsCollectionPage> GetAsync(CancellationToken cancellationToken)
        {
            Method = "GET";
            var response = await SendAsync<QuestionsCollectionResponse>(null, cancellationToken)
                .ConfigureAwait(false);
        ...
        public IQuestionsCollectionRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IQuestionsCollectionRequest Top(int value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IQuestionsCollectionRequest Filter(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IQuestionsCollectionRequest Skip(int value)
        {
        ...
        /// <returns></returns>
        public IQuestionsCollectionRequest OrderBy(string value)
        {
