...
namespace ServiceNow.Graph.Requests
{
    ...
    public class LocationsCollectionRequest : BaseRequest, ILocationsCollectionRequest
    {
        ...
        public LocationsCollectionRequest(string requestUrl, IBaseClient client,
            ...
            CancellationToken cancellationToken)
        {
            ...
            Method = "POST";
            var response = await SendAsync<LocationResponse>(entity, cancellationToken)
        ...
        {
            Method = "GET";
            var response = await SendAsync<LocationsCollectionResponse>(null, cancellationToken)
                .ConfigureAwait(false);
        ...
        public ILocationsCollectionRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ILocationsCollectionRequest Top(int value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ILocationsCollectionRequest Filter(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public ILocationsCollectionRequest Skip(int value)
        {
        ...
        /// <returns></returns>
        public ILocationsCollectionRequest OrderBy(string value)
        {
