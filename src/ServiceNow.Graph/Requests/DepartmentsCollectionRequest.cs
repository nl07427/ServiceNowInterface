...
namespace ServiceNow.Graph.Requests
{
    ...
    /// </summary>
    public class DepartmentsCollectionRequest : BaseRequest, IDepartmentsCollectionRequest
    {
        /// <summary>
        ...
        public DepartmentsCollectionRequest(string requestUrl, IBaseClient client,
            ...
            CancellationToken cancellationToken)
        {
            ...
            Method = "POST";
            var response = await SendAsync<DepartmentResponse>(entity, cancellationToken)
        ...
        public async Task<IDepartmentsCollectionPage> GetAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The collection page.</returns>
        public async Task<IDepartmentsCollectionPage> GetAsync(CancellationToken cancellationToken)
        {
            Method = "GET";
            var response = await SendAsync<DepartmentsCollectionResponse>(null, cancellationToken)
                .ConfigureAwait(false);
        ...
        public IDepartmentsCollectionRequest Select(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IDepartmentsCollectionRequest Top(int value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IDepartmentsCollectionRequest Filter(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IDepartmentsCollectionRequest Skip(int value)
        {
        ...
        /// <returns></returns>
        public IDepartmentsCollectionRequest OrderBy(string value)
        {
